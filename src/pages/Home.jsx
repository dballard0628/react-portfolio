  ...
  return (
    <div className="home-container">
      <div className="page-wrapper">
        ...
        <p className="home-description">Hi! I'm Danah, a 32-year-old aspiring software engineer from sunny Miami, Florida. I'm currently enrolled in a full stack web development bootcamp, where I am sharpening my skills in technologies like JavaScript, React, Node.js, Express, and PostgreSQL.
